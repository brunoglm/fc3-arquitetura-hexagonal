...
import (
	...
	dbInfra "github.com/arquitetura-hexagonal/adapters/db"
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".arquitetura-hexagonal" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigType("yaml")
		viper.SetConfigName(".arquitetura-hexagonal")
	}
